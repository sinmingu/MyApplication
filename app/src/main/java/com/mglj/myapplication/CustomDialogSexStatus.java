...
public class CustomDialogSexStatus {

    private Context context;

    public CustomDialogSexStatus(Context context) {
    ...
    public void callFunction(final TextView edit_today_walk) {
        ...
        dlg.setContentView(R.layout.custom_sex_status);
        ...
        okButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(pet_sex1.isChecked())
                    edit_today_walk.setText("예");
                else if(pet_sex2.isChecked())
                    edit_today_walk.setText("아니요");
                else if(pet_sex3.isChecked())
                    edit_today_walk.setText("모름");
